...
const Feature = () => {
    return (
        <Container>
        <div className='m-16'>
            <h2 className='text-xl md:text-4xl font-bold  text-center'>FEATURES OF OUR<span className='text-orange-600 '>LIBRARY MANAGEMENT SYSTEM</span></h2>
            <div className='flex flex-col md:flex-row gap-12 space-y-5 mt-12'>
                <div>
